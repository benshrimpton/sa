	  ...
	  $cat_posts = new WP_Query(
		...
		?>
			<li class="cat-post-item">
				...
				<p class="post-date"><?php the_time("j M"); ?></p>
				<?php endif; ?>
				<?php
					$array_cat = get_the_category();
					$cat_slug = array();
					foreach($array_cat AS $value)
					{
						...
						//echo "Got Irix";
							...
							?>
							<a class="sidebar_cat" href="<?php //echo esc_url( $category_link ); ?>" title="Category Name"><?php //echo $value->name; ?></a>
							<?php
							//echo $value->name." ";
						}
					}
				$title_old_sb = get_the_title();
				if (strpos($title_old_sb,':') !== false) {
					$arra_tit = explode(":",$title_old_sb);
					$title =  $arra_tit[1];
				}
				elseif (strpos($title_old_sb,'/') !== false) {
					$arra_tit = explode("/",$title_old_sb);
					$title =  $arra_tit[1];
				}
				else{
				...
				?>
				<a class="sidebar_cat" href="" title="Category Name"><?php echo $arra_tit[0]; ?></a>
				<a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>"><?php echo $title; ?></a>		
				<?php if ( isset( $instance['excerpt'] ) ) : ?>
				<?php the_excerpt(); ?> 
				<?php endif; ?>
				<a class="read_art" style="float: left;" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
					READ ARTICLE>>
				</a>
