...
class WPPG_Gallery_Home
{
    ...
    function render_gallery_home()
    {
        ...
        <div id="wppg_gallery_container">
            <div class="wppg_gallery_item_container_main">
        <?php 
        if (!empty($galleries))
        {
           $i=1;
		...
		//$al_thumb_url=$item->thumbnail_url;
                $thumb_image_url='#';
                ...
                if($gallery_items){
                    ...
                    $al_thumb_url = $gallery_items[0]['image_url'];
                }
                ...
                if(strlen($gallery_name) > 14){
                 ...
                 if($i%2==0)
                    {
                        $class=" wppg_gallery_item_container_2";
                    }
                    else{
                         $class="";
                    }
                ?> 
                <div class="wppg_gallery_item_container<?php echo $class; ?>">
                    <div class="wppg_gallery_item_top">
                        <div class="wppg_gallery_item_thumbnail">
                        <a href='<?php echo $page_link ?>'>
                                <img class="wppg_gallery_item_thumb" src='<?php echo $al_thumb_url ?>' alt='<?php //echo $gallery_name; ?>' title="<?php echo $gallery_name; ?>" />
                        </a>
                        </div>
                    </div>
                    <div class="wppg_gallery_item_bottom">
                        <a href="<?php echo $page_link; ?>" title="<?php echo $gallery_name; ?>"><div class="wppg_gallery_item_name"><p style="top: 50%; position: relative; color: #fff;"><?php echo $gallery_name_short; ?></p></div></a>
                    </div>
            </div>
    <?php
        if($i%2==0)
            {
                echo '</div><div class="wppg_gallery_item_container_main">';
            }
            $i++;
            } 
        }
