                ...
                foreach($items as $item)
                {
                    ...
                    <div class="wppg_album_item_container">
                        ...
                        <div class="wppg_album_item_bottom">
                            <a href="<?php echo $page_link; ?>" title="<?php echo $gallery_name; ?>"><div class="wppg_album_item_name"><p style="top: 50%; position: relative; color: #000 !important;"><?php echo $gallery_name_short; ?></p></div></a>
                        </div>
                    </div>
    <?php 
                } 
