...
?>
            ...
            <div id="wppg_albumcontainer">
                <div class="wppg_album_item_container_main">
<?php
            $i = 1;
            if (!empty($items))
            {
                foreach($items as $item)
                {
                    ...
                    if($gallery_items){
                        ...
                        $thumb_image_url = $gallery_items[0]['image_url']; //Get the thumb URL of the first gallery item
                    }
                    ...
                    if(strlen($gallery_name) > 14){
                     ...
                     if($i%2==0)
                    {
                        $class=" wppg_album_item_container_2";
                    }
                    else{
                         $class="";
                    }
                    ?> 
                   <div class="wppg_album_item_container<?php echo $class; ?>">
                        ...
                        <div class="wppg_album_item_bottom">
                            <a href="<?php echo $page_link; ?>" title="<?php echo $gallery_name; ?>"><div class="wppg_album_item_name"><p style="top: 50%; position: relative; color: #fff;"><?php echo $gallery_name_short; ?></p></div></a>
                        </div>
                   </div>
    ...
    <?php
            if($i%2==0)
            {
                echo '</div><div class="wppg_album_item_container_main">';
            }
            $i++;
                } 
            }
