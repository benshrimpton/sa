...
class CHPCS {
	...
	foreach( $myposts as $post ){
		...
		$date_post = strtoupper(get_the_time('M j', $post->ID));
		$slider_gallery .= '<span class="chpcs_date">'.$date_post.'</span>';
		if($display_excerpt){
	...
	if($display_controls) {
		...
		$ur = get_bloginfo('template_url');
		$im = "<img src='".$ur."/images/more_slider_btn.jpg' />";
		$slider_gallery.='<a class="chpcs_next" id="wa_chpc_slider_next" href="#"><span>'.$im.'</span></a>';	
